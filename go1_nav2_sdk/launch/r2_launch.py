...
def generate_launch_description():
    ...
    declare_params_file = DeclareLaunchArgument(
        ...
        # default_value = os.path.join(path_sdk, 'params', 'r2.yaml'),
        default_value = os.path.join(path_sdk, 'params', 'r2.yaml'),
    ...
    group_slam = GroupAction([
        ...
        SetRemap(src='/map', dst='/r2/map'),
        SetRemap(src='/map_metadata', dst='/r2/map_metadata'),
        SetRemap(src='/map_updates', dst='/r2/map_updates'),
        SetRemap(src='/scan', dst='/r2/scan'),
        include_slam,
    ])
    ...
    group_rviz = GroupAction([
        # PushRosNamespace(namespace = namespace),
        # SetRemap(src='/follow_waypoints', dst='/r2/follow_waypoints'),
        # SetRemap(src='/navigate_through_poses', dst='/r2/navigate_through_poses'),
        # SetRemap(src='/navigate_to_pose', dst='/r2/navigate_to_pose'),
        node_rviz,
    ])
